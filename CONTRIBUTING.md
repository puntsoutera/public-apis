...
* The Description should not exceed 100 characters. <!-- Note to self: I kept breaking this rule — keep descriptions concise, e.g. "NASA data, including imagery" not a full sentence explaining everything -->
* Verify the API is still active and the documentation link is not a 404 before submitting. <!-- personal reminder: I've wasted time on dead links -->
